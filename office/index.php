...
<?php  include("includes/navbar.php"); ?>
        ...
        <div class="card">
             ...
             <div class="card-body bg-info">
                ...
                $total_notice= "select * from notice where notice_department='$de'";
    ...
    // Display result
            ...
            <button type="submit" name="details_btn" class="btn  btn-success"> See More Details</button>
             ...
             <div class="card-body bg-info">
                ...
                $total_notice= "select * from equipment where Department='$de'";
                if ($result = mysqli_query($conn, $total_notice)) {
    ...
    // Display result
            ...
            <form action="officerDetails.php" method="post">
