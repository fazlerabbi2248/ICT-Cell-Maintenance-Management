...
<?php  include("includes/navbar.php"); ?>
                ...
                <div class="container-fluid">
                    ...
                    <p class="mb-4">
                      Here you are going to add new equipment for your Department
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">ADD new Equipment</h6>
                        </div>
                        <div class="card-body">
                                       <form class="form-horizontal" action="equipment-addinfo.php" method="POST">
                                              ...
                                              <input type="date" id="expiry-date" name="expiry_date">                                                
                                                ...
                                                <div class="form-group"> 
                                                  <label class="control-label col-sm-4"><h5 class="font-weight-bold">Department Name :</h5></label>
