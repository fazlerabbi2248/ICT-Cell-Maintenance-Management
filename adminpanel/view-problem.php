                                    ...
                                    <tbody>
                                         ...
                                         <?php  include("conn.php"); ?>
                                                  ...
                                                  <?php
                                                     ...
                                                     $sql= "select * from equipment e,pendingproblem p where  e.EquipmentID=p.EquipmentID"; 
                                                  ...
                                                  <tr class="text-dark">
                                                      ...
                                                      <td>
                                                              <form action="equipment-problem-delete.php" method="post">
                                                              <input type="hidden" name="delete_id" value="<?php echo $data['prob_id']; ?>">
