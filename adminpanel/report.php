										...
										<nav class="navbar navbar-inverse">
										  <div class="container-fluid">
										    ...
										    <ul class="nav navbar-nav">
										      ...
										      <li><a href="#">Using Department</a></li>
										    </ul>
										  </div>
								</nav>  
                            ...
                            <?php 
                               include("conn.php");
                                if(isset($_GET['from_date']) && isset($_GET['to_date']))
                                {
                                    ...
                                    $query = "SELECT * FROM equipment WHERE included_date BETWEEN '$from_date' AND '$to_date' ";
                            ...
                            <?php 
                               include("conn.php");
                                if(isset($_GET['Equipment_Type']))
                                {
                                    ...
                                    $query1 = "SELECT * FROM equipment WHERE Equipment_Type='$type' ";
