     ...
     ?>
      <div class="col-lg-6 col-md-6 col-12">
        ...
        <div class="card">
            ...
            <form action="authority-update-details.php" method="post">
            <input type="hidden" name="update_id" value="<?php echo $data['autho_id']; ?>">
            <button type="submit" name="update_btn" class="btn  btn-success"> Update Information</button>
            </form>
             </div>
        </div>
      </div>
